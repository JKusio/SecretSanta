  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-r from-red-600 via-red-600 to-red-700">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <input className="text-center text-[64px] bg-transparent border-b-2 border-white focus:outline-none text-white" type="text" value={inputValue}
          onChange={handleInputChange} />
        <button className="mt-10 bg-white text-red-600 text-[48px] px-10 py-5 rounded-full" onClick={onSecretCodeSubmit}> Submit </button>
      </div>
    </main>
  )
}
